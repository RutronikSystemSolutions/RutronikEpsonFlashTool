...
unsigned char aucIscTestReq[HEADER_LEN + LEN_ISC_TEST_REQ] = {
	...
	//0x00, 0x00, 0x00, 0x00,   //  for release
	0x85, 0x1F, 0xAA, 0x1A, // default key-code 1AAA1F85 
...
unsigned char aucIscSpiSwitch[HEADER_LEN + ID_ISC_SPISW_IND] = {

	0x00, ID_START,

	LEN_ISC_SPISW_IND, 0x00,

	_GET_LOW_BYTE(ID_ISC_SPISW_IND), _GET_HIGH_BYTE(ID_ISC_SPISW_IND),

};

int iIscSpiSwitchLen = sizeof(aucIscSpiSwitch);
